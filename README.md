...
**TermSnap** 是一款专为 macOS 设计的轻量级生产力工具，集成了 **智能截图标注**、**滚动长截图** 以及 **Finder 快捷打开终端** 三大核心功能。它常驻于菜单栏，旨在为开发者和设计师提供最丝滑的工作流。
...
### 2. 滚动截图 (Long Screenshot) 🌟
- **突破屏幕限制**：支持截取长网页、长代码文件或终端历史记录。
- **智能拼接**：采用高性能图像特征匹配算法，自动缝合滚动过程中的画面。
- **实时预览**：滚动时侧边预览面板实时显示拼接进度，支持自动识别滚动边界。

### 3. Finder 扩展 (Open Terminal Here)
